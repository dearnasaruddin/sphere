            ...
            <Container>
                ...
                <div className="flex gap-x-19 mt-11.5 font-montserrat">
                    ...
                    <ul className='flex flex-col gap-y-9 whitespace-nowrap font-medium text-lg text-[#2C2C2C] leading-[130%] pl-6 mt-11 relative after:absolute after:h-76 after:w-0.5 after:rounded-sm after:-top-4.5 after:left-0  after:bg-[#E2E2E2]'>
                        <li onClick={() => setActiveCategory("computer")} className={activeCategory === "computer" ? "relative after:absolute after:z-10 after:-left-6 after:top-1/2 after:-translate-y-1/2 after:w-0.5 after:h-11 after:rounded-sm after:bg-primary" : ""}>
                            <Link>Computer & Laptop<span className='ml-4.5 text-base font-bold py-1.5 px-3 text-[#EDEDEF] bg-[#1F2537] rounded-lg'>15</span></Link>
                        </li>
                        <li onClick={() => setActiveCategory("mobile")} className={activeCategory === "mobile" ? "relative after:absolute after:z-10 after:-left-6 after:top-1/2 after:-translate-y-1/2 after:w-0.5 after:h-11 after:rounded-sm after:bg-primary" : ""}>
                            <Link>Mobile & Phone<span className='ml-4.5 text-base font-bold py-1.5 px-3 text-[#1F2537] bg-[#AFE638] rounded-lg'>35</span></Link>
                        </li>
                        <li onClick={() => setActiveCategory("camera")} className={activeCategory === "camera" ? "relative after:absolute after:z-10 after:-left-6 after:top-1/2 after:-translate-y-1/2 after:w-0.5 after:h-11 after:rounded-sm after:bg-primary" : ""}>
                            <Link>Camera Imaging<span className='ml-4.5 text-base font-bold py-1.5 px-3 text-[#EDEDEF] bg-primary rounded-lg'>10</span></Link>
                        </li>
                        <li onClick={() => setActiveCategory("tv")} className={activeCategory === "tv" ? "relative after:absolute after:z-10 after:-left-6 after:top-1/2 after:-translate-y-1/2 after:w-0.5 after:h-11 after:rounded-sm after:bg-primary" : ""}>
                            <Link>TV & Smart Box<span className='ml-4.5 text-base font-bold py-1.5 px-3 text-[#1F2537] bg-[#F1F1F2] rounded-lg'>8</span></Link>
                        </li>
                        <li onClick={() => setActiveCategory("appliance")} className={activeCategory === "appliance" ? "relative after:absolute after:z-10 after:-left-6 after:top-1/2 after:-translate-y-1/2 after:w-0.5 after:h-11 after:rounded-sm after:bg-primary" : ""}>
